...
class SteerableReasoner:
    ...
    def __init__(self, config: Dict[str, Any], memory: AdaptiveMemory):
        ...
        self.endpoint = config.get('azure_endpoint', "https://it-li-m9l4hi9c-eastus2.cognitiveservices.azure.com/")
        self.model_name = config.get('model_name', 'o3')
        self.deployment = config.get('deployment', 'o3')
